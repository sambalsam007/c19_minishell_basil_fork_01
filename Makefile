...
#    Updated: 2025/01/07 13:21:23 by bclaeys          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXECUTOR_SRCS = echo.c builtin_checks.c pwd_and_cd.c export.c run_binary.c redir_checks.c pipe_functions.c binary_path_creation.c heredoc.c
